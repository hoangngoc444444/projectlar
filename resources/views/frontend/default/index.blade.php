            ...
            <div class="side-menu animate-dropdown">
                ...
                <nav class="yamm megamenu-horizontal" role="navigation">
                    <ul class="nav">
                        ...
                        <li class="dropdown menu-item">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Cameras &amp;
                                Photography</a>
                            <ul class="dropdown-menu mega-menu">
                                <li class="yamm-content">
                                    <!-- ================================== MEGAMENU VERTICAL ================================== -->
                        ...
                        <li class="dropdown menu-item">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Car Electronic &amp;
                                GPS</a>
                            <ul class="dropdown-menu mega-menu">
                                <li class="yamm-content">
                                    <!-- ================================== MEGAMENU VERTICAL ================================== -->
    ...
    <div class="container">
        <div class="tab-holder">
            ...
            <ul class="nav nav-tabs">
                <li class="active"><a href="#lastest-products" data-toggle="tab">Sản Phẩm Mới</a></li>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="lastest-products">
                            ...
                            <div class="product-item">
                                ...
                                <div class="image">
                                    ...
                                    file_exists(public_path(get_thumbnail("uploads/$product->image"))))
                                     <a href="{{ route('frontend.home.show',['slug' => str_slug($product->name),'id' => $product->id]) }}"><img src="{{ asset(get_thumbnail("uploads/$product->image")) }}" alt="Image"
                                         data-echo="{{ asset(get_thumbnail("uploads/$product->image")) }}"></a>
                                    @else
                                    <a href="{{ route('frontend.home.show',['slug' => str_slug($product->name),'id' => $product->id]) }}"><img src="{{ asset('images/no_image.jpg') }}" alt="No Image"
                                        ></a>
                                    @endif
                                ...
                                <div class="body">
                                    ...
                                    <div class="brand">{{ $product->category->name }}</div>
                                </div>
                                <div class="prices">
                                    <div class="price-prev">{{ number_format($product->regular_price) }}</div>
                                    <div class="price-current pull-right">{{ number_format($product->sale_price) }}
                                    </div>
                                </div>

                                <div class="hover-area">
                                    <div class="add-cart-button">
                                        <a href="single-product.html" class="le-button">Thêm Vào giỏ hàng</a>
                                    </div>
                                    {{-- <div class="wish-compare">
                                            <a class="btn-add-to-wishlist" href="#">Cho vào danh sách ưa thích</a>
                        ...
                        <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="image">
                                    ...
                                    file_exists(public_path(get_thumbnail("uploads/$feature->image"))))
                                     <a href="{{ route('frontend.home.show',['slug' => str_slug($feature->name),'id' => $feature->id]) }}"><img src="{{ asset(get_thumbnail("uploads/$feature->image")) }}" alt="Image"
                                         data-echo="{{ asset(get_thumbnail("uploads/$feature->image")) }}"></a>
                                    @else
                                    <a href="{{ route('frontend.home.show',['slug' => str_slug($feature->name),'id' => $feature->id]) }}"><img src="{{ asset('images/no_image.jpg') }}" alt="No Image"
                                        ></a>
                                    @endif
                                    {{-- <img alt="" src="{{ asset('themes/default/assets/images/blank.gif') }}"
                                        data-echo="{{ asset('uploads/'.$feature->image) }}" /> --}}
                                </div>
                                <div class="body">
                                    {{-- <div class="label-discount green">-50% sale</div> --}}
                                    <div class="title">
                                        <a href="{{ route('frontend.home.show',['slug' => str_slug($feature->name),'id' => $feature->id]) }}">{{ $feature->name }}</a>
                                    </div>
                                    <div class="brand">{{ $feature->category->name }}</div>
                                </div>
                                <div class="prices">
                                    <div class="price-prev">{{ number_format($feature->regular_price) }}</div>
                                    <div class="price-current pull-right">{{ number_format($feature->sale_price) }}
                                    </div>
                                </div>
            ...
            <div id="owl-recently-viewed" class="owl-carousel product-grid-holder">
                ...
                <div class="no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            ...
                            <div class="image">
                                <img alt="" src="{{ asset('themes/default/assets/images/blank.gif') }}"
                                    data-echo="{{ $recent_product->image ? asset('uploads/'. get_thumbnail($recent_product->image,'_450x337')): asset('images/no_image.jpg')}}" />
                            </div>
                            <div class="body">
                                <div class="title">
                                    <a href="single-product.html">{{$recent_product->name}}</a>
                                </div>
                                <div class="brand">{{$recent_product->category->name}}</div>
                            </div>
                            <div class="prices">
                                <div class="price-current text-right">{{$recent_product->price}}</div>
                            </div>
                            <div class="hover-area">
                                <div class="add-cart-button">
                                    <a href="single-product.html" class="le-button">Thêm vào giỏ hàng</a>
